...
export class GroupRepo {
  ...
  private async create(group: Group): Promise<Group> {
    ...
    await getDb().insertInto("groups").values({
      ...
      discussionsEnabled: (group.discussionsEnabled ?? true) as any,
      announcementsEnabled: (group.announcementsEnabled ?? true) as any,
  ...
  protected rowToModel(row: any): Group {
    const result: Group = {
      ...
      discussionsEnabled: row.discussionsEnabled === undefined || row.discussionsEnabled === null ? true : !!row.discussionsEnabled,
      announcementsEnabled: row.announcementsEnabled === undefined || row.announcementsEnabled === null ? true : !!row.announcementsEnabled,
