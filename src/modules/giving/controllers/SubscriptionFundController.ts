  ...
  public async get(
    ...
    return this.actionWrapper(req, res, async (au) => {
      if (!au.checkAccess(Permissions.donations.viewSummary)) return this.json(null, 401);
        ...
        return this.repositories.subscriptionFunds.convertToModel(
          au.churchId,
          await this.repositories.subscriptionFunds.load(au.churchId, id)
        );
    });
  }
    ...
    return this.actionWrapper(req, res, async (au) => {
      if (req.query.subscriptionId !== undefined) {
        ...
        if (!permission) return this.json([], 401);
          ...
          return await this.repositories.subscriptionFunds.loadBySubscriptionId(
            au.churchId,
      ...
      if (!au.checkAccess(Permissions.donations.view)) return this.json([], 401);
        ...
        return this.repositories.subscriptionFunds.convertAllToModel(
          au.churchId,
          (await this.repositories.subscriptionFunds.loadAll(au.churchId)) as any[]
        );
    });
  }
